...
import { readStoredCartItems, writeStoredCheckoutInfo } from "../../lib/checkout-storage.ts";
              ...
              <Card>
                <CardBody className="space-y-3">
                  ...
                  <p className="text-sm text-ink-500">
                    Complete checkout without an account. Sign in to save your order history and
